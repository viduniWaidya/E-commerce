  ...
  return (
    <div className='descriptionbox'>
      ...
      <div className='descriptionbox-description'>
        ...
        <p>E-commerce websites typically display products or services and detailed descriptions images, prices, and any available vary(e.g, sizes, colors). Each product usually has its own dedicate with relevant information.</p>
      </div>
    </div>
  )
}
